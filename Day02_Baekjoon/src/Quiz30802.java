...
//
//티셔츠를
//T장씩 최소 몇 묶음 주문해야 하는지,
//그리고 펜을 P 자루씩 최대 몇 묶음 주문할 수 있고,
...
public class Quiz30802 {
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        int[] size = new int[6]; // s, m, l, xl, xxl, xxxl 순서로 입력받을 배열
        ...
        for(int i = 0; i < size.length; i++){
            resultTTotal += size[i] / t;
            if(size[i] % t != 0){
                resultTTotal++;
            }
        }
        System.out.println(resultTTotal);

        int resultPTotal = n / p;
        System.out.print(resultPTotal + " ");
        resultPTotal = n % p;
        System.out.print(resultPTotal);
    }
}
